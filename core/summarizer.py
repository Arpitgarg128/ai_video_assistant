...
def get_llm():
    """
    Returns a ChatMistralAI instance configured with the API key and model.
    """
...
def summarize(transcript: str) -> str:
    ...
    chunks_summarizes = [map_chain.invoke({"text": chunk}) for chunk in chunks]

    combined = "\n\n".join(chunks_summarizes)
